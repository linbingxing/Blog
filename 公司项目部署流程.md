...
![ansible基本架构](D:\Blog\image\ansible基本架构.png)
...
![MySql角色定义](D:\Blog\image\MySql角色定义.png)
...
![jenkis源码地址配置](D:\Blog\image\jenkis源码地址配置.png)

配置ansible Playbook的脚本

![jenkis配置主机](D:\Blog\image\jenkis配置主机.png)

配置钉钉通知

![jenkis钉钉通知](D:\Blog\image\jenkis钉钉通知.png)

好啦，开始构建之旅。。。

## 4、docker部署流程

![docker部署流程](D:\Blog\image\docker部署流程.png)
